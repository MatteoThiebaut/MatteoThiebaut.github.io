    ...
    <section class="text-white mt-20" id="projects">
        <div class="px-4 xl:pl-16">
            <div class="mb-4 md:flex md:justify-between xl:pr-16">
                <h2 class="text-4xl font-bold text-white"> Réalisations</h2>
            </div>
            <ul class="px-4 sm:py-16 xl:pr-16 grid grid-cols-1 gap-6 pt-10 sm:grid-cols-2 md:gap-10 md:pt-12 lg:grid-cols-3"
                ...
                <div v-for="project in Projects" :key="project.id">
                    ...
                    <div class="text-white rounded-b-xl min-h-72 mt-3 bg-[#111a3e] shadow-lg border border-[#1f1641] py-6 px-4">
                        <h3 class="text-lg font-semibold uppercase lg:text-xl mb-4"> {{ project.title }}</h3>
...
const Projects = ref([
    {
        ...
        webURL: 'https://www.newwalkings.com/'
    },
    {
        id: 2,
        image: img2,
        ...
        webURL: 'https://www.reveil-musical.fr/'
    },
    {
        id: 3,
        image: img3,
        ...
        webURL: 'https://www.esperance08.com/'
    },
]);
